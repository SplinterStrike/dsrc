...
public class splinter_test extends script.base_script
{
    public splinter_test()
    {
    }
    public int OnSpeaking(obj_id self, String text) throws InterruptedException
    {       
        case (command.equals("nsg_customizeship_oid"))
        {
            obj_id objShip = utils.StringToObjId(tok.nextToken());
